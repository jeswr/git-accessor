import { IdentifierStrategy, InternalServerError, guardedStreamFrom, isInternalContentType } from '@solid/community-server';
...
import { POSIX } from '@solid/community-server/dist/util/Vocabularies';
...
export class MyDataAccessor implements DataAccessor {
  ...
  public constructor(identifierStrategy: IdentifierStrategy) {
    console.log('MyDataAccessor constructor');
  ...
  public async getData(identifier: ResourceIdentifier): Promise<Guarded<Readable>> {
    console.log('MyDataAccessor getData', identifier);
